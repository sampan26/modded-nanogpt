...
val_loader = DataLoaderLite(B=32, T=T, process_rank=ddp_rank, num_processes=ddp_world_size, split="val")
...
if master_process:
    ...
    print(f"Final Training time: {elapsed_time_minutes:.2f} minutes")
